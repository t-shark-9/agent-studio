...
import { Plane, UtensilsCrossed, Image, ArrowRight, ArrowLeft, MapPin, Calendar, DollarSign, Users, Clock, Utensils, Camera, Video, Palette } from 'lucide-react';
import { Card, CardContent } from '@/components/ui/card';
import { Button } from '@/components/ui/button';

interface IntentCardFlowProps {
...
const FLOWS: Record<string, { icon: React.ElementType; label: string; description: string; steps: FlowStep[] }> = {
  trip: {
    icon: Plane,
    label: 'Plan a Trip',
    description: 'Let me help you plan your perfect getaway',
    steps: [
      {
...
export function IntentCardFlow({ onComplete }: IntentCardFlowProps) {
  ...
  // Show flow selection cards
  if (!activeFlow) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-6">
        <div className="text-center mb-8">
          <h2 className="text-xl font-bold text-foreground mb-2 font-display">What can I help you with?</h2>
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full px-6">
      ...
      <div className="w-full max-w-lg mb-6 space-y-3">
        ...
        <h3 className="text-lg font-semibold text-foreground text-center font-display">{step.question}</h3>
      </div>
